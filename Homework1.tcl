# 
# Project automation script for Homework1 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source Homework1.tcl), then you can
...
set myProject "Homework1"
set myScript "Homework1.tcl"
...
proc add_source_files {} {
   ...
   xfile add "DFF.v"
   xfile add "DNlatch.v"
   xfile add "DNlatch_NOR.v"
   xfile add "Dlatch_NAND.v"
   xfile add "Dlatch_NOR.v"
   xfile add "FULL_ADDER.v"
   xfile add "INVERTER.v"
   xfile add "MUX2.v"
   xfile add "MUX32.v"
   xfile add "NAND.v"
   xfile add "NOR.v"
   ...
   xfile add "XOR.v"
   xfile add "testDFF.v"
   xfile add "testDNlatch_NAND.v"
   xfile add "testDNlatch_NOR.v"
   xfile add "testDlatch_NAND.v"
   xfile add "testDlatch_NOR.v"
   xfile add "testFULL_ADDER.v"
   xfile add "testINVERTER.v"
   xfile add "testMUX2.v"
   xfile add "testMUX32.v"
   xfile add "testNAND.v"
   xfile add "testNOR.v"
   xfile add "testREG32.v"
   xfile add "testXOR.v"

   # Set the Top Module as well...
   project set top "INVERTER"
...
proc set_process_props {} {
   ...
   project set "Project Description" "Modules Inverter,NAND,NOR,XOR
and 
FullAdder(1bit) , 1-bit,2input MUX2 
and using thoose ther modules as well"
   ...
   project set "Work Directory" "D:/Projects/XilinxISE/HW1/Homework1/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "INVERTER" -process "Generate IBIS Model"
